...
## Data preprocessing
### Data cleaning
Cutoff point: {{menu2_cut}}

Before cut:
![image](/assets/menu2/raw_data_histogram.svg)

After cut:
![image](/assets/menu2/clean_data_{{menu2_cut}}_cut_histogram.svg)

## Network construction

![image](/assets/menu2/{{menu2_normalisation_method}}_{{menu2_threshold_method}}_{{menu2_variance_cut}}_{{menu2_coexpression_measure}}_network.svg)

...
function network_construction(raw_counts::DataFrame,config_file::String;clear_cache::Bool=false,archive::Bool=false)
        ...
        ##update cache
        cache_dir = "$cwd/output/cache/$(params["test_name"])/cutoff/$(params["data_preprocessing"]["expression_cutoff"])"
        run(`mkdir -p $(cache_dir)`)
        ...
        ### Normalisation
        ##update cache
        cache_dir = "$cwd/output/cache/$(params["test_name"])/cutoff/$(params["data_preprocessing"]["expression_cutoff"])/normalisation/$(params["data_preprocessing"]["norm_method"])"
        run(`mkdir -p $(cache_dir)`)
        ...
        ##update cache
        cache_dir = "$cwd/output/cache/$(params["test_name"])/cutoff/$(params["data_preprocessing"]["expression_cutoff"])/normalisation/$(params["data_preprocessing"]["norm_method"])/sampling/$(params["data_preprocessing"]["variance_percent"])"
        run(`mkdir -p $(cache_dir)`)
        ...
        ##update cache
        cache_dir = "$cwd/output/cache/$(params["test_name"])/cutoff/$(params["data_preprocessing"]["expression_cutoff"])/normalisation/$(params["data_preprocessing"]["norm_method"])/sampling/$(params["data_preprocessing"]["variance_percent"])/similarity/$(params["network_construction"]["coexpression"])"
        run(`mkdir -p $(cache_dir)`)
        ...
        ## Adjacency matrix 
        ##update cache
        cache_dir = "$cwd/output/cache/$(params["test_name"])/cutoff/$(params["data_preprocessing"]["expression_cutoff"])/normalisation/$(params["data_preprocessing"]["norm_method"])/sampling/$(params["data_preprocessing"]["variance_percent"])/similarity/$(params["network_construction"]["coexpression"])/threshold/$(params["network_construction"]["threshold"])/threshold_method/$(params["network_construction"]["threshold_method"])"
        run(`mkdir -p $(cache_dir)`)
